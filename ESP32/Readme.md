...
```text
ESP32 sensors → JSON → HTTP POST → Supabase REST API
                                 ↑
                           (or n8n webhook first)
```
...
```text
[DATA] T=28.45°C V=3.700V I=0.4500A Gx=0.02 Gy=-0.01 Gz=0.00 anomaly=none
[HTTP] POST OK (201)
```
